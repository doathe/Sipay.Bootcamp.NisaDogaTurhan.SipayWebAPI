...
namespace BookStoreWebAPI.Migrations
{
    ...
    [Migration("20230802020950_initMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreWebAPI.Entities.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateOnly(1960, 4, 20),
                            Name = "Eric",
                            Surname = "Ries"
                        },
                        new
                        {
                            Id = 2,
                            BirthDate = new DateOnly(1970, 4, 20),
                        ...
                        {
                            Id = 3,
                            BirthDate = new DateOnly(1980, 4, 20),
                            Name = "Frank",
                            Surname = "Herbert"
                        });
                });
            ...
            modelBuilder.Entity("BookStoreWebAPI.Entities.Book", b =>
                {
                    b.HasOne("BookStoreWebAPI.Entities.Author", "Author")
                        .WithMany("Books")
