...
public class UserController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateUser([FromBody] CreateUserModel entity)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateUser(int id, [FromBody] UpdateUserModel entity)
    {
