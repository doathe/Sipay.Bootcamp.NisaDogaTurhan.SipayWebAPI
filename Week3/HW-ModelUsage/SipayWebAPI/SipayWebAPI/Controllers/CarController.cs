...
public class CarController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateCar([FromBody] CreateCarModel entity)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateCar(int id, [FromBody] UpdateCarModel entity)
    {
        await _carService.UpdateAsync(id, entity);
